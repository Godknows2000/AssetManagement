...
namespace AMS.Web.Models
{
    public static class EmailExtensions
    {
        ...
        public static void SendAssetEmail(this AssetRequest AssetRequest, EmailSender emailSender, HttpContext context, bool sendAsync = true, string Content = null, string To = null, string btnText = null, string url = null)
        {
            var Customer = AssetRequest.Employee?.FirstName;
            string Subject = "Application acknowledgement";
            string to = AssetRequest.Employee?.IdNavigation.Email ?? To;
            var HostEnvironment = context.RequestServices.GetService<IWebHostEnvironment>();
